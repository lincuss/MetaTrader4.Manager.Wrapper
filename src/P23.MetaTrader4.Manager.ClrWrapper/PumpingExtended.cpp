...
int P23::MetaTrader4::Manager::ClrWrapper::PumpingSwitchEx(P23::MetaTrader4::Manager::Contracts::PumpingMode pumpingFlag)
{
	...
	return _manager->Manager->PumpingSwitchEx((MTAPI_NOTIFY_FUNC_EX)Marshal::GetFunctionPointerForDelegate(_extendedPumpingCallBack).ToPointer(), (int)pumpingFlag, NULL);
}
